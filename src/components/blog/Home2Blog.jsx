...
const Home2Blog = () => {
  return (
    <>
      <div className="home2-blog-section mb-120 home2-gradient-bg">
          ...
          <div className="row g-lg-4 gy-5">
              ...
              <div className="blog-card style-2">
                <div className="blog-card-img-wrap">
                  <Link href="/blog/blog-details" className="card-img">
                    <img src="/assets/img/home2/blog-card-img1.png" alt="" />
                  </Link>
                ...
                <div className="blog-card-content">
                  ...
                  <h5>
                    <Link href="/blog/blog-details">
                      Discover Hidden Gems: A Guide to Off-the-Beaten-Path Destinations.
                    </Link>
                  </h5>
            ...
            <div className="col-lg-6">
              <div className="blog-card style-2">
                <div className="blog-card-img-wrap">
                  <Link href="/blog/blog-details" className="card-img">
                    <img src="/assets/img/home2/blog-card-img2.png" alt="" />
                  </Link>
                  <Link href="/blog" className="date">
                    <span>
                      <strong>15</strong> <br /> June
                    </span>
                  </Link>
                </div>
                <div className="blog-card-content">
                  ...
                  <h5>
                    <Link href="/blog/blog-details">
                      Essential Travel Tips for Your Next Adventure Abroad.
                    </Link>
                  </h5>
                  <div className="bottom-area">
                    <Link href="/blog/blog-details">
