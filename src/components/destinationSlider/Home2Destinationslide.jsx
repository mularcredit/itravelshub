...
const Home2Destinationslide = () => {
  ...
  return (
    <>
      <div
        className="destination-card2-slider-section mb-120 home2-gradient-bg"
        style={{
          padding: "120px 0",
          position: "relative",
        }}
            ...
            <div className="col-lg-12">
              <div className="section-title2 text-center">
                <div className="eg-section-tag">
                  <span style={{ color: '#ffa500' }}>Journey iTravelsHub</span>
                </div>
                <h2 style={{ color: '#fff' }}>Trendy Travel Locations</h2>
              </div>
            </div>
          </div>
          <div className="row">
