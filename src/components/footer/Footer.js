            ...
            <div className="col-lg-4 col-md-6 col-sm-6 d-flex justify-content-lg-center justify-content-md-start">
              <div className="footer-widget">
                <div className="single-contact mb-30">
                  ...
                  <a href="tel:+254728327423">+254 728 327423</a>
                </div>
                <div className="single-contact mb-35">
                  ...
                  <a href="mailto:info@itravelshub.com">info@itravelshub.com</a>
                </div>
                <div className="single-contact">
                  ...
                  <a href="#">
                    Nairobi, Westlands, Western Heights Building
                  </a>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6 d-flex justify-content-lg-end justify-content-sm-end">
              <div className="footer-widget">
                <div className="widget-title">
                  <h5>We Are Here</h5>
                </div>
                <p>
                  Your trusted partner for seamless travel experiences. We're here to help you discover amazing destinations and create unforgettable memories.
                </p>
                <div className="payment-partner">
                  ...
                  <div className="icons">
                    <ul>
                      ...
                      <li>
                        <img
                          src="/assets/img/home1/icon/imgi_1_logo-capitalpay.png"
                          alt=""
                        />
                      </li>
                    </ul>
          ...
          <div className="row">
            <div className="col-lg-12 d-flex flex-md-row flex-column align-items-center justify-content-md-between justify-content-center flex-wrap gap-3">
              ...
              <div className="copy-right-content">
                <p>
                  Copyright @ {new Date().getFullYear()} <Link href="/">itravelshub</Link>{" "}
                </p>
              </div>
